        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {allProjects.map((project) => (
            <Link
              ...
              key={project.id}
              className="group relative rounded-2xl bg-white/5 border border-white/10 hover:border-brand-cyan/50 overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)] block"
            >
              {/* Top Status Bar */}
              ...
              {/* Project Image */}
              <div className="w-full h-48 overflow-hidden border-b border-white/5 relative group-hover:h-56 transition-all duration-300 z-10">
                {project.image ? (
                  <>
                    <img
                      src={project.image}
              ...
              <div className="p-6 relative z-20 bg-brand-black/50 backdrop-blur-sm">
                <div className="mb-4">
